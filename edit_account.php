...
Edit Account Photo         </h6>
                           </div>
                           <div class="card-body align-self-center ">
                <img class="img-circle img-size-2" width="340" height="340" src="uploads/users/<?php echo $user['image'];?>" alt="">
...
<button type="submit" name="submit" class="btn btn-primary btn-icon-split"><span class="icon text-white-50">
<i class="fas fa-sync-alt"></i>
                          </span>                          <span class="text">Change Photo</span></button></span>
