...
<?php include_once('layouts/header.php'); ?>
  ...
  <div class="card shadow mb-4">
                     <div class="card-header py-3">
                         <h6 class="m-0 font-weight-bold text-primary">Edit Groups</h6>
...
<button type="submit" name="update_group" class="btn btn-primary btn-icon-split"><span class="icon text-white-50">
<i class="fas fa-sync-alt"></i>
                          </span>
                          <span class="text">Update Group</span></button></div>
    </form></div></div>
