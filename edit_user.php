                         ...
                         <div class="card shadow mb-4">
                           <div class="card-header py-3">
                             <h6 class="m-0 font-weight-bold text-primary">
                               <i class="fas fa-th"></i>  Update <?php echo remove_junk(ucwords($e_user['name'])); ?> Account
                             </h6>
                           </div>
                           <div class="card-body">
...
<button type="submit" name="update_product" class="btn btn-primary btn-icon-split"><span class="icon text-white-50">
<i class="fas fa-sync-alt"></i>
                          </span>
                          <span class="text">Update USER</span></button></div>
        </form>
       </div>
     </div>
  </div>
  ...
  <div class="card shadow mb-4">
                           <div class="card-header py-3">
                             <h6 class="m-0 font-weight-bold text-primary">
                             <i class="fas fa-th"></i>  Change <?php echo remove_junk(ucwords($e_user['name'])); ?> password
                             </h6>
                           </div>
                           <div class="card-body">
...
<button type="submit" name="update-pass" class="btn btn-warning btn-icon-split"><span class="icon text-white-50">
<i class="fas fa-sync-alt"></i>
                          </span>
                          <span class="text">Change Password</span></button></div>
